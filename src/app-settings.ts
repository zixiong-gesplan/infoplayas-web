...
export class AppSettings {
    ...
    public static idportalForms = '4df033868833441798c532394806601c';
    public static idportalView = '81e40ab3616b4b4386058593078eaddf';
    public static idportalDrownings = '81e2f8adabc04ebb8572bd715696cf54';
    public static urlServerRest = 'https://gesplan.maps.arcgis.com/sharing/rest';
    public static urlSelfinfo = '/community/self';
    public static roles = [
        {
            id: '6eaujmQDyuNamfzU',
            name: 'infoplayas',
